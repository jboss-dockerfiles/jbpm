...
* jBPM Workbench version is `7.6.0.Final`
...
* See release notes for [jBPM](http://docs.jboss.org/jbpm/release/7.6.0.Final/jbpm-docs/html_single/#_jbpmreleasenotes)
