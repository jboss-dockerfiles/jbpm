...
* jBPM Workbench version is `7.5.0.Final`
...
* See release notes for [jBPM](http://docs.jboss.org/jbpm/release/7.5.0.Final/jbpm-docs/html_single/#_jbpmreleasenotes)
